 ...
 * through {@link com.wasu.thirdparty.image.ImageLoader ImageLoader}.
 * It can wrap any Android {@link android.view.View View} which can be accessed by {@link #getWrappedView()}. Wrapped
 * view is returned in {@link com.wasu.thirdparty.image.ImageLoadingListener ImageLoadingListener}'s
 * callbacks.
 *
...
public interface ImageAware {
	...
	/**
	 * Returns {@linkplain com.wasu.thirdparty.image.ViewScaleType scale type} which is used for
	 ...
	 * {@link com.wasu.thirdparty.image.ImageLoadingListener#onLoadingCancelled(String,
	 ...
	 * {@linkplain com.wasu.thirdparty.image.DisplayImageOptions.Builder#showImageForEmptyUri(
	 *android.graphics.drawable.Drawable) for empty Uri},
	 * {@linkplain com.wasu.thirdparty.image.DisplayImageOptions.Builder#showImageOnLoading(
	 *android.graphics.drawable.Drawable) on loading} or
	 * {@linkplain com.wasu.thirdparty.image.DisplayImageOptions.Builder#showImageOnFail(
	 *android.graphics.drawable.Drawable) on loading fail}. These drawables can be specified in
	 * {@linkplain com.wasu.thirdparty.image.DisplayImageOptions display options}.<br />
	 * Also can be called in {@link com.wasu.thirdparty.image.BitmapDisplayer BitmapDisplayer}.< br />
	 * Is called on UI thread if ImageLoader was called on UI thread. Otherwise - on background thread.
	 *
	 ...
	 * {@link com.wasu.thirdparty.image.BitmapDisplayer BitmapDisplayer}.< br />
	 * Is called on UI thread if ImageLoader was called on UI thread. Otherwise - on background thread.
	 *
