...
import com.person.thirdparty.image.FailReason.FailType;
import com.person.thirdparty.image.ImageDownloader.Scheme;

/**
 * Presents load'n'display image task. Used to load image from Internet or file system, decode it to {@link Bitmap}, and
 * display it in {@link com.wasu.thirdparty.image.ImageAware} using {@link DisplayBitmapTask}.
 *
